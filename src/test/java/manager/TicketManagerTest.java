...
class TicketManagerTest {
    ...
    private Ticket first = new Ticket(1, 1000, "VKO","AER", 350);
    private Ticket second = new Ticket(2, 2000, "SVO","SIP", 420);
    private Ticket third = new Ticket(3,  3000, "DME", "TAS", 98);
